class Snail {
  ...
  render () {
    ...
    this.element.innerHTML = (
      `<div class="snail-racer" id="snail-slide">
  ...
  update() {
    ...
    const shell = this.querySelector ('.snail__shell');
    shell.style.fill = this.color;
    document.addEventListener('keyspace', () => {

    })
    const speed = this.querySelector ('.snail-racer');
    speed.style. transition = this.speed;
  }
